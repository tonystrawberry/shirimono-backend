...
#  status(Status of the user course level grammar (e.g. not_started, partially_in_progress, all_in_progress, completed)) :integer          default(0), not null
...
class UserCourseLevelGrammarLinkTest < ActiveSupport::TestCase
  # test "the truth" do
  #   assert true
  # end
end
