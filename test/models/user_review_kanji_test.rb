...
#  user_course_level_kanji_id(UserCourseLevelKanji that the review belongs to)                :bigint           not null
#
# Indexes
#
#  index_user_review_kanjis_on_kanji_exercise_id           (kanji_exercise_id)
#  index_user_review_kanjis_on_kanji_id                    (kanji_id)
#  index_user_review_kanjis_on_user_course_level_kanji_id  (user_course_level_kanji_id)
#  index_user_review_kanjis_unique                         (user_course_level_kanji_id,kanji_exercise_id,kanji_id) UNIQUE
#
# Foreign Keys
#
...
class UserReviewKanjiTest < ActiveSupport::TestCase
  # test "the truth" do
  #   assert true
  # end
end
