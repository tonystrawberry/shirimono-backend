...
#  course_level_kanji_links_count(Number of kanjis in the level) :integer          default(0), not null
...
class CourseLevelKanji < ApplicationRecord
  ...
  validates :course_level_kanji_links_count, presence: true, numericality: { greater_than_or_equal_to: 0 }
